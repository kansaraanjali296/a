...
def generate_file_name(cenex_ahm_td_url):
    try:
        #----------------------------------------------url get file_name -------------------------------------------------#
        file_name = cenex_ahm_td_url.split('https://')[1].split("/")[0].replace(".", "_") + '_tender'
        return file_name
...
try:
    ...
    cenex_ahm_td_url = 'https://www.cenexahmedabad.nic.in/tender.html'
    driver.get(cenex_ahm_td_url)

    file_name = generate_file_name(cenex_ahm_td_url)
    ...
    files_dir = os.path.expanduser('~') + "\\Documents\\" + "PythonFile\\" + cenex_ahm_td_url.split('https://')[1].split("/")[0] + "py_tender\\" + "File"
